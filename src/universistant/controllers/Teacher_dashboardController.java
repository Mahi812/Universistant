...
public class Teacher_dashboardController implements Initializable {
    ...
    @FXML
    private void clickChangePassword(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/resources/fxml/change_passwordTea.fxml"));
        background.getChildren().setAll(pane);
    }    
}
